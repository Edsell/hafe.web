                         ...
                         <div class="bd-program-thumb-wrapper">
                            <a href="program-details.html">
                               <div class="bd-program-thumb-2">
                                  <img src="{{ asset('assets/img/program/home-program-1.jpg') }}" alt="Image not found">
                               </div>
                            </a>
                         </div>
                   ...
                   <div class="swiper-slide">
                      <div class="bd-program-2 clr-2">
                         <div class="bd-program-thumb-wrapper">
                            <a href="program-details.html">
                               <div class="bd-program-thumb-2">
                                  <img src="{{ asset('assets/img/program/home-program-2.jpg') }}" alt="Image not found">
                               </div>
                            </a>
                         </div>
                         <div class="bd-program-content mb-10">
                   ...
                   <div class="swiper-slide">
                      <div class="bd-program-2 clr-3">
                         <div class="bd-program-thumb-wrapper">
                            <a href="program-details.html">
                               <div class="bd-program-thumb-2">
                                  <img src="{{ asset('assets/img/program/home-program-3.jpg') }}" alt="Image not found">
                               </div>
                            </a>
                         </div>
                         <div class="bd-program-content mb-10">
