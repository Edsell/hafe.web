<section class="bd-teacher-area-2 theme-bg">
    <div class="container">
       <div class="bd-teacher-bg-wrapper pt-120 pb-120 p-relative">
          <div class="bd-teacher-bg d-none d-xl-block" data-background="{{ asset('assets/img/bg/teacher-bg.jpg') }}"></div>
                            ...
                            <div class="bd-teacher-thumb-wrapper-2 mb-20 p-relative">
                               <a href="teacher-details.html">
                                  <div class="bd-teacher-thumb-2">
                                     <img src="{{ asset('assets/img/teacher/7.jpg') }}" alt="Image not found">
                                  </div>
                               </a>
                      ...
                      <div class="col-xl-3 col-lg-6 col-md-6">
                         <div class="bd-teacher-2 p-relative z-index-1 mb-40 wow fadeInUp" data-wow-duration="1s"
                            ...
                            <div class="bd-teacher-thumb-wrapper-2 mb-20 p-relative">
                               <a href="teacher-details.html">
                                  <div class="bd-teacher-thumb-2">
                                     <img src="{{ asset('assets/img/teacher/8.jpg') }}" alt="Image not found">
                                  </div>
                               </a>
                               <div class="bd-teacher-social-2">
                                  <ul>
                      ...
                      <div class="col-xl-3 col-lg-6 col-md-6">
                         <div class="bd-teacher-2 p-relative z-index-1 mb-40 wow fadeInUp" data-wow-duration="1s"
                            ...
                            <div class="bd-teacher-thumb-wrapper-2 mb-20 p-relative">
                               <a href="teacher-details.html">
                                  <div class="bd-teacher-thumb-2">
                                     <img src="{{ asset('assets/img/teacher/6.jpg') }}" alt="Image not found">
                                  </div>
                               </a>
                               <div class="bd-teacher-social-2">
                                  <ul>
                      ...
                      <div class="col-xl-3 col-lg-6 col-md-6">
                         <div class="bd-teacher-2 p-relative z-index-1 mb-40 wow fadeInUp" data-wow-duration="1s"
                            ...
                            <div class="bd-teacher-thumb-wrapper-2 mb-20 p-relative">
                               <a href="teacher-details.html">
                                  <div class="bd-teacher-thumb-2">
                                     <img src="{{ asset('assets/img/teacher/5.jpg') }}" alt="Image not found">
                                  </div>
                               </a>
                               <div class="bd-teacher-social-2">
                                  <ul>
